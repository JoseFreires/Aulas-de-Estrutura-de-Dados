// LIFO: Trata-se de uma estrutura do tipo PILHA onde o último elemento que entra
// será o primeiro elemento a ser removido da pilha, como em uma pilha de livros
// ou pratos. 
